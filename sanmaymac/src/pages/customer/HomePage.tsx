...
const MOCK_PRODUCTS: Product[] = [
  { id: 1, name: 'Áo thun Uniform 2024', workshopName: 'Việt Tiến', basePrice: 350000, averageRating: 4.9, reviewCount: 128, categoryId: 1, workshopId: 1, createdAt: '', images: [{ id: 1, imageUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDE2-K8q2wlC3u3xy4EwG44BCsLD8O9TBRYOPjTFwQrzQGLS5eGIPNidkrt9G2a0tJhbORl9oM9hcokbMNA1MQR2XNxcymuUDUxUYHg2_Mb8WW5a_cBC-TJnSGXB6cJ5ueLKKJ_ZsNYuiGGdqMRcAPlz1my6h-m08cxMEVCvsl9L4IOQVV7fbkXVhLEoj9JcbZIek5pbCN0TlHQxIiKiJn1_66orfUhCw57nwGgGpqdGbQsQyvLQkS8g9AhY5xD1-IquJOoFLZfhxE', isThumbnail: true }] },
  { id: 2, name: 'Quần Chinos Slim-fit', workshopName: 'Blue Ocean', basePrice: 550000, averageRating: 4.7, reviewCount: 94, categoryId: 2, workshopId: 2, createdAt: '', images: [{ id: 2, imageUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCPk7NQnUyqwhIJ3SdZHpcGJi5XcCF4E8ryRnuld00sqoy0mcR-PjIaUnjCZzwm4wYpCvj4xZb_JDzaEySUjsj8ASW0iTt8BAjylFZDwSfbFKtvDySqT90Pdm2Us3iT4rvAHMvTjlCYHkO3LacLqOkhWRNK-QHx8Lk7LMgSys7B7bvDCpBWhvyr09yss8E1WdVTjHtXwXjENY8P60MQ_RBdff74d-VQOw4dhFu0ZD1jgamP9f_TGKK6Cshww8-2gHoFlj9ASDvmg6k', isThumbnail: true }] },
  { id: 3, name: 'Váy Maxi Boho Collection', workshopName: 'Thăng Long', basePrice: 480000, averageRating: 4.8, reviewCount: 76, categoryId: 3, workshopId: 3, createdAt: '', images: [{ id: 3, imageUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAvyz_OyKNvmR7lZpNBz0w25KnHCpK9aZuTcibDA3vEsCFeUh7yyV7FRX_QF7FDYdo29bL5sqOvzHNFNXrrGQyRkR_yybydTIn0VM_yxn-dIya0TX0rSsLm-uQEiYj2v2iGtpih5M0ozVSQjKw_dw9LOaK7zT96G-9vqH3vAd3Ls0-LhC0GnAQilch5WwnyDZg2_CziRd6enauYeoRabephIwVjYXpsrcQQy1PMUHcBROnVHsxXqKsLR_4xFqXlsKxB4aH2ZrkxLN8', isThumbnail: true }] },
  { id: 4, name: 'Đồng phục công ty Premium', workshopName: 'Việt Tiến', basePrice: 420000, averageRating: 5.0, reviewCount: 163, categoryId: 1, workshopId: 1, createdAt: '', images: [{ id: 4, imageUrl: 'https://lh3.googleusercontent.com/aida-public/AB6AXuDE2-K8q2wlC3u3xy4EwG44BCsLD8O9TBRYOPjTFwQrzQGLS5eGIPNidkrt9G2a0tJhbORl9oM9hcokbMNA1MQR2XNxcymuUDUxUYHg2_Mb8WW5a_cBC-TJnSGXB6cJ5ueLKKJ_ZsNYuiGGdqMRcAPlz1my6h-m08cxMEVCvsl9L4IOQVV7fbkXVhLEoj9JcbZIek5pbCN0TlHQxIiKiJn1_66orfUhCw57nwGgGpqdGbQsQyvLQkS8g9AhY5xD1-IquJOoFLZfhxE', isThumbnail: true }] },
];
...
const MOCK_WORKSHOPS = [
  { id: 1, name: 'Xưởng May Việt Tiến', location: 'TP. Hồ Chí Minh', rating: 4.9, orders: 1240, speciality: 'Đồng phục & Áo thun', verified: true, img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCtmv82IrPxVAAX5KcBAbIMuBWZkrRFmiIGGXd-Dn3FFK-jrO8MY3ReyUX_Gim8MqvVjccJeGCMQ1qsbFcdSojZk3FSMYoM4VQUW8BtlA4Pyy2Exg8139tG8qlaOdL40UV4Lh2DICCZncTpMLCx_7wuNJhwCUSKRxB5jRMTc5HJ6URik2St9Jwj3EeDC7Ucx_hsOlfQcVL0x_QKFACosQm-m5aggOiA-FLg_yq0c2cMvJ-fmtZSXocP-iBWl3PhijbP7EKoTEQ8ha8' },
  { id: 2, name: 'Blue Ocean Garment', location: 'Hà Nội', rating: 4.7, orders: 890, speciality: 'Thời trang cao cấp', verified: true, img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCPk7NQnUyqwhIJ3SdZHpcGJi5XcCF4E8ryRnuld00sqoy0mcR-PjIaUnjCZzwm4wYpCvj4xZb_JDzaEySUjsj8ASW0iTt8BAjylFZDwSfbFKtvDySqT90Pdm2Us3iT4rvAHMvTjlCYHkO3LacLqOkhWRNK-QHx8Lk7LMgSys7B7bvDCpBWhvyr09yss8E1WdVTjHtXwXjENY8P60MQ_RBdff74d-VQOw4dhFu0ZD1jgamP9f_TGKK6Cshww8-2gHoFlj9ASDvmg6k' },
  { id: 3, name: 'Thăng Long Fashion', location: 'Đà Nẵng', rating: 4.8, orders: 670, speciality: 'Váy & Thời trang nữ', verified: false, img: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAvyz_OyKNvmR7lZpNBz0w25KnHCpK9aZuTcibDA3vEsCFeUh7yyV7FRX_QF7FDYdo29bL5sqOvzHNFNXrrGQyRkR_yybydTIn0VM_yxn-dIya0TX0rSsLm-uQEiYj2v2iGtpih5M0ozVSQjKw_dw9LOaK7zT96G-9vqH3vAd3Ls0-LhC0GnAQilch5WwnyDZg2_CziRd6enauYeoRabephIwVjYXpsrcQQy1PMUHcBROnVHsxXqKsLR_4xFqXlsKxB4aH2ZrkxLN8' },
];
...
export const HomePage = () => {
  ...
  useEffect(() => {
    ...
    if (cachedCategories) {
      setCategories(cachedCategories.length ? cachedCategories : MOCK_CATEGORIES);
    ...
    <CustomerLayout>
      ...
      <section className="max-w-[1400px] mx-auto px-4 md:px-8 py-14">
        <div className="flex items-center justify-between mb-8">
          <h2 className="text-2xl font-bold text-on-surface">Danh mục sản phẩm</h2>
          <Link to="/products" className="text-secondary text-sm font-medium hover:underline flex items-center gap-1">
            ...
            {categories.slice(0, 8).map((cat) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="text-xs font-bold text-on-surface text-center">{cat.name}</span>
                </Link>
              );
            })}
          </div>
      ...
      <section className="bg-surface-container-lowest py-14">
        <div className="max-w-[1400px] mx-auto px-4 md:px-8">
          <div className="flex items-center justify-between mb-8">
            <div>
              <h2 className="text-2xl font-bold text-on-surface">Sản phẩm nổi bật</h2>
              <p className="text-on-surface-variant text-sm mt-1">Được đặt hàng nhiều nhất tuần này</p>
            </div>
            <Link to="/products" className="text-secondary text-sm font-medium hover:underline flex items-center gap-1">
              Xem tất cả <span className="material-symbols-outlined text-sm">arrow_forward</span>
            </Link>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-5">
            {loadingProducts
              ...
              : products.map((product) => (
                  <div key={product.id} className="bg-white border border-outline-variant rounded-2xl overflow-hidden hover:shadow-lg hover:border-secondary/40 transition-all group">
                    ...
                    <div className="p-4">
                      ...
                      <p className="text-xs text-on-surface-variant mt-1">By {product.workshopName ?? '—'}</p>
                      {(product.averageRating ?? 0) > 0 && (
                        <div className="flex items-center gap-1 mt-2">
                          <span className="material-symbols-outlined text-amber-500 text-sm" style={{ fontVariationSettings: "'FILL' 1" }}>star</span>
                          <span className="text-xs font-bold text-on-surface">{product.averageRating?.toFixed(1)}</span>
                      ...
                      <div className="flex items-center justify-between mt-3">
                        ...
                        <Link to="/cart" className="p-2 bg-secondary-fixed rounded-full hover:bg-secondary text-secondary hover:text-white transition-all">
      ...
      <section className="bg-secondary py-14">
        <div className="max-w-[1400px] mx-auto px-4 md:px-8 flex flex-col md:flex-row items-center justify-between gap-8">
          <div>
            <h2 className="text-white font-bold text-2xl md:text-3xl mb-2">Có nhu cầu gia công số lượng lớn?</h2>
            <p className="text-white/80 font-body-md">Đăng yêu cầu và nhận báo giá từ hàng trăm xưởng trong 24 giờ.</p>
          </div>
          <Link to="/create-tender" className="flex-shrink-0 px-8 py-4 bg-white text-secondary font-bold rounded-xl hover:shadow-xl transition-all">
            Đăng yêu cầu ngay
          </Link>
        </div>
      </section>
      ...
      <section className="max-w-[1400px] mx-auto px-4 md:px-8 py-14">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h2 className="text-2xl font-bold text-on-surface">Xưởng may uy tín</h2>
            <p className="text-on-surface-variant text-sm mt-1">Được đánh giá cao bởi hàng nghìn khách hàng</p>
          </div>
          <Link to="/workshop-directory" className="text-secondary text-sm font-medium hover:underline flex items-center gap-1">
            Xem tất cả <span className="material-symbols-outlined text-sm">arrow_forward</span>
          </Link>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {loadingWorkshops
            ...
            : (workshops.length ? workshops : MOCK_WORKSHOPS).map((ws) => {
                ...
                const name = isReal ? (ws as PublicWorkshop).shopName : (ws as typeof MOCK_WORKSHOPS[0]).name;
                const rating = isReal ? (ws as PublicWorkshop).ratingAvg : (ws as typeof MOCK_WORKSHOPS[0]).rating;
                const verified = isReal ? (ws as PublicWorkshop).isVerified : (ws as typeof MOCK_WORKSHOPS[0]).verified;
                const address = isReal ? (ws as PublicWorkshop).workshopAddress : (ws as typeof MOCK_WORKSHOPS[0]).location;
                const desc = isReal ? (ws as PublicWorkshop).description : (ws as typeof MOCK_WORKSHOPS[0]).speciality;
                const avatar = isReal ? (ws as PublicWorkshop).avatarUrl : (ws as typeof MOCK_WORKSHOPS[0]).img;
                const capacity = isReal ? (ws as PublicWorkshop).productionCapacity : null;
                ...
                return (
                  ...
                  >
                    ...
                    <div className="h-40 overflow-hidden relative bg-gradient-to-br from-primary/10 to-secondary/10">
                      {avatar ? (
                        ...
                        <div className="w-full h-full flex items-center justify-center">
                          <span className="material-symbols-outlined text-6xl text-primary/30">factory</span>
                        </div>
                      )}
                      {verified && (
                    ...
                    <div className="p-5">
                      <h3 className="font-bold text-on-surface group-hover:text-secondary transition-colors line-clamp-1">{name}</h3>
                      {address && (
                      ...
                      {desc && <p className="text-xs text-on-surface-variant mt-1 line-clamp-1">{desc}</p>}
                      ...
                      <div className="flex items-center justify-between mt-4 pt-4 border-t border-outline-variant">
                        ...
                        {capacity ? (
                          <span className="text-xs text-on-surface-variant">{capacity.toLocaleString()} sp/tháng</span>
                        ) : (
                          <span className="text-xs text-on-surface-variant">{(ws as typeof MOCK_WORKSHOPS[0]).orders?.toLocaleString()} đơn</span>
                        )}
                      </div>
                    </div>
                  </Link>
      ...
      <section className="bg-surface-container-lowest py-14">
        <div className="max-w-[1400px] mx-auto px-4 md:px-8">
          <div className="text-center mb-12">
            <h2 className="text-2xl font-bold text-on-surface mb-2">Cách hoạt động</h2>
            <p className="text-on-surface-variant font-body-md">Chỉ 3 bước để bắt đầu đặt hàng gia công</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { step: '01', icon: 'search', title: 'Tìm xưởng phù hợp', desc: 'Duyệt qua hàng nghìn xưởng may được xác minh, lọc theo vị trí, chuyên môn và đánh giá.' },
              { step: '02', icon: 'description', title: 'Gửi yêu cầu báo giá', desc: 'Mô tả sản phẩm, số lượng và yêu cầu kỹ thuật. Nhận báo giá chi tiết trong vòng 24 giờ.' },
              { step: '03', icon: 'local_shipping', title: 'Theo dõi & nhận hàng', desc: 'Theo dõi tiến độ sản xuất theo thời gian thực và nhận hàng đúng hẹn.' },
            ].map((item) => (
